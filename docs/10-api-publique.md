...
*Contrat des fichiers publiés. Dernière vérification : 31 juillet 2026.*
...
| `indicateurs.json` | Catalogue : identifiant, libellé, unité, thème, cadre comptable, sommabilité, définition grand public et technique, formule, badges, périodes disponibles | 31 ko |
