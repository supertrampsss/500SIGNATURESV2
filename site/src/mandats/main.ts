...
async function action(target: HTMLElement) {
  ...
  else if (a === "helper") { sheet("Quel mandat choisir ?", "<p><strong>La ville</strong> : des écoles, des équipements et des quartiers. Les projets sont concrets, les budgets de fonctionnement et d'investissement distincts. 45 décisions sur six années.</p><p><strong>La France</strong> : fiscalité, services, énergie et dette, avec des effets à l'échelle de profils territoriaux du mandat. 45 décisions sur cinq années.</p><p>Les deux parcours sont entièrement jouables sur téléphone, sans compte.</p>"); return; }
  else if (a === "method") { sheet("Comprendre les conséquences", `<p>Les communes choisies utilisent un instantané de comptes publiés. Les coûts des mesures, les zones et les effets restent des hypothèses de jeu. Les effets suivent les règles de la simulation.</p><p>Le mandat long comporte 45 décisions. Le plan évolue à chaque dossier, mais intérêts, dette et trésorerie sont comptabilisés une seule fois en fin d’année. Les livraisons suivent leur calendrier. Le détail reste dans le journal.</p><p>Le bilan des nouvelles parties compte les finances pour 40 %, les services pour 20 %, la cohésion et la confiance pour 20 %, puis la résilience et l’état des équipements pour 20 %. Les anciennes parties conservent leurs règles et leur pondération. La confiance est un indice de jeu, pas une intention de vote.</p><a class="button" href="/mandats/methode/">Lire les règles et les sources</a>`); return; }
