...
export function decode(raw: string): Game {
  ...
  if ((v.version !== 1 && v.version !== 2 && v.version !== 3 && v.version !== 4 && v.version !== 5 && v.version !== 6 && v.version !== 7 && v.version !== 8 && v.version !== 9) || typeof v.mode !== "string" || !Object.hasOwn(DOMAINS, v.mode) || !Array.isArray(v.choices) || !v.choices.every(x => typeof x === "string" && x.length<=64) || typeof v.seed !== "number") throw new Error("Version ou format de sauvegarde non pris en charge.");
