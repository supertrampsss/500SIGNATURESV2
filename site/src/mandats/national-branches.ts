...
const stories = [
 'Les pensions sont des revenus versés après la retraite. La baisse envisagée touche celles qui dépassent la petite retraite ; supprimer un abattement augmenterait l’impôt des retraités concernés.',
 'Les agents accueillent le public et instruisent les dossiers. Ne pas remplacer les départs réduit les effectifs ; les remplacements limitent l’allongement des délais.',
 'La TVA est payée lors des achats. La relever augmente le prix payé par les consommateurs ; réduire les aides à la consommation retire un soutien direct à certains ménages.',
 'Les subventions sont des aides aux entreprises ; les exonérations réduisent leurs cotisations sur les salaires. Modifier l’une ou l’autre change différemment leurs projets et leurs embauches.',
 'Les remboursements de santé réduisent ce que les patients paient de leur poche. Les restreindre renchérit certains soins ; financer autrement la santé déplace la charge vers d’autres contributeurs.',
 'Les prestations sociales apportent un revenu ou une aide selon les ressources du foyer. Abaisser les plafonds exclut des ménages qui avaient jusque-là droit à ces aides.',
 'Les aides non contributives ne dépendent pas des cotisations versées, contrairement aux droits acquis par le travail. Les conditionner à la durée de résidence demanderait une réforme juridique.',
 'Les associations financent des activités d’entraide, de loisirs et d’accès aux droits. Sans subvention, certaines réduisent leurs activités ou ne peuvent plus payer leurs salariés.',
 'L’âge de départ détermine quand une personne peut demander sa retraite. Le repousser réduit les années de pension, mais les salariés concernés doivent pouvoir rester en emploi.',
 'Regrouper des services hospitaliers concentre certains soins et fonctions sur moins de sites. Les hôpitaux peuvent réduire leurs coûts, mais les patients doivent parfois parcourir plus de distance.',
 'Le point d’indice sert à calculer le salaire de base des agents publics. Le geler ralentit l’évolution de leur rémunération et peut rendre certains postes moins attractifs.',
 'L’allocation chômage remplace une partie du salaire après une perte d’emploi. Réduire sa durée signifie que les demandeurs peuvent perdre ce revenu avant d’avoir retrouvé un poste.',
 'Les aides aux énergies fossiles réduisent le coût du carburant ou d’autres combustibles. Les supprimer renchérit ces usages, surtout pour ceux qui n’ont pas encore d’alternative.',
 'Les aides au logement réduisent le loyer à payer pour les locataires éligibles. Un plafond plus bas peut augmenter leur facture ; taxer les résidences secondaires fait contribuer leurs propriétaires.',
 'Les collectivités locales gèrent des services et des équipements près des habitants. Mutualiser leurs équipes peut supprimer des doublons, mais éloigner l’accueil des communes.',
 'Le crédit d’impôt recherche réduit l’impôt des entreprises qui déclarent des dépenses de recherche. Il complète les subventions directes, mais ne finance pas les mêmes projets.',
 'Les allocations familiales apportent un soutien aux parents qui élèvent des enfants. Réduire les droits selon le revenu ou l’avantage fiscal change la part payée par chaque famille.',
 'L’audiovisuel public et les opérateurs culturels financent des programmes, spectacles et activités. Réduire leurs budgets peut supprimer des contenus et des offres locales.',
 'Les dépenses internationales financent l’aide, la coopération et les actions menées avec d’autres pays. Les réduire limite les programmes que la France peut soutenir.',
 'Les grands projets d’infrastructure mobilisent des crédits sur plusieurs années. En préparer moins réduit les investissements futurs, mais aussi les chantiers et équipements disponibles.',
];
