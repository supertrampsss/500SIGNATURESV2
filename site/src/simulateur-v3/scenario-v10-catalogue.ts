...
const REPLACEMENTS: Record<string, Replacement> = {
  ...
  "tranche-a-50-au-dela-de-250": { id: "unifier-ir-csg-bareme-continu", chapterId: TAX, kind: "transformation", title: "Faut-il remplacer l'IR et la CSG par un barème progressif continu ?", context: "Un seul barème progressif remplace l'IR et la CSG. Tous les revenus contribuent dès le premier euro, sans impôt négatif.", subject: "un barème personnel progressif continu", legal: "Préserver les cotisations contributives, sans impôt négatif, et voter le calibrage de rendement.", beneficiaries: ["finances publiques", "lisibilité fiscale"], contributors: ["titulaires de revenus d'activité, de remplacement et du capital"], indicator: "institutionalTrust", group: "privateEmployees", sourceKeys: ["dgfip-ir-2024", "ccss-csg-2025", "cgi-197", "senat-mecss-prelevements-personnels-2025"], estimateKey: "personal-levy-progressive-gross", year: 2 },
  ...
  "raboter-de-5-les-subventions-directes-aux": { id: "supprimer-subventions-directes-entreprises", chapterId: WORK, kind: "transformation", title: "Faut-il supprimer les subventions budgétaires directes restantes aux entreprises ?", context: "À l'issue des contrats en cours, le scénario supprime les subventions directes restantes, hors dispositifs déjà chiffrés ailleurs.", subject: "l'extinction des subventions budgétaires directes actives", legal: "Respecter les engagements contractuels et les règles européennes d'aides d'État.", beneficiaries: ["transparence publique", "finances publiques"], contributors: ["bénéficiaires des aides supprimées"], indicator: "institutionalTrust", group: "businesses", sourceKeys: ["hcsp-aides-entreprises-2025", "senat-aides-entreprises-2025"], estimateKey: "business-direct-subsidies-residual", year: 5 },
  ...
  "reduire-de-5-les-dotations-aux-collectivites": { id: "clarifier-competences-doublons-territoriaux", chapterId: STATE, kind: "transformation", title: "Faut-il clarifier les compétences et doublons territoriaux ?", context: "Les compétences en doublon sont supprimées sans reprendre les achats, l'immobilier, les absences ni les opérateurs déjà chiffrés ailleurs.", subject: "la clarification des compétences territoriales", legal: "Garantir la continuité des services et la consultation des collectivités.", beneficiaries: ["usagers", "collectivités clarifiées"], contributors: ["structures en doublon"], indicator: "institutionalTrust", group: "localAuthorities", sourceKeys: ["igf-collectivites-2024", "senat-ravignon", "senat-ravignon-2025"], estimateKey: "territorial-competencies-net", year: 5 },
