...
const AUDITED_ENTRIES: Record<string, BudgetEstimate> = {
  ...
  [registryId("unifier-ir-csg-bareme-continu", "adopt", "personal-levy-progressive-gross")]: audited("personal-levy-progressive-gross", 2025, 17_900, "objectif", "Barème progressif continu dès le premier euro, sans impôt négatif ; cotisations contributives hors périmètre. Les 17,9 Md€ proviennent du calibrage de rendement équivalent à un point de CSG sur activité, remplacement, patrimoine et placement, non de la fusion technique IR-CSG.", 17_900, 0, 0, 17_900, ["dgfip-ir-2024", "ccss-csg-2025", "cgi-197", "senat-mecss-prelevements-personnels-2025"], ["personal-levy-progressive-one-point"], "scenario", "forte"),
  ...
  [registryId("supprimer-subventions-directes-entreprises", "adopt", "business-direct-subsidies-residual")]: audited("business-direct-subsidies-residual", 2025, 24_600, "objectif", "Extinction, à l'issue des contrats en cours, des subventions budgétaires directes actives : 44 Md€ IGF/Sénat, moins 6,5 Md€ de compensations de cotisations, 9 Md€ d'extinctions programmées, 1,2 Md€ d'apprentissage, 1,5 Md€ de bonus automobile et 1,2 Md€ de soutien aux renouvelables déjà chiffrés ailleurs. Exclut ces cinq postes pour éviter tout double compte.", 24_600, 0, 0, 24_600, ["hcsp-aides-entreprises-2025", "senat-aides-entreprises-2025"], ["business-direct-budget-subsidies-residual"], "scenario", "forte"),
  ...
  [registryId("clarifier-competences-doublons-territoriaux", "adopt", "territorial-competencies-net")]: audited("territorial-competencies-net", 2025, 7_500, "objectif", "Scénario plafond du coût annuel du millefeuille territorial. Exclut les achats, l'immobilier, les absences et les opérateurs, déjà traités par des dossiers distincts.", 7_500, 0, 0, 7_500, ["igf-collectivites-2024", "senat-ravignon", "senat-ravignon-2025"], ["local-competency-staff-overlap"], "scenario", "forte"),
