...
const schoolModels = ["cheque-education-par-eleve", "supprimer-le-financement-public-du-prive", "autonomie-complete-des-etablissements"];
...
export const EDUCATION_DECISIONS = [
  ...
  p({
    ...
    event: delayedEvent("housing-rent-capture", "Les loyers absorbent une part de l'aide", "Dans les zones les plus tendues, une partie de la hausse se retrouve dans les nouveaux loyers.", 3, "opinion", -3),
  }),
  p({
  ...
  standalonePolicy({
    ...
    sourceKeys: ["depp-ecole-2025", "education-chiffres-2025", "itm-50-decisions"], evidenceLabel: "Dépense par élève, résultats et écarts sociaux entre établissements.", conflicts: schoolModels,
    options: [
      { id: "adopt", label: "Créer le chèque éducation", summary: "Le financement suit le choix des familles et les établissements perdant des élèves perdent aussi des moyens.", budgetDelta: -1_000, beneficiaries: ["familles mobiles", "établissements attractifs"], contributors: ["établissements évités", "mixité scolaire"], uncertainty: "forte", indicatorEffects: { reformCapacity: 6, publicServices: -4, opinion: 2 }, groupEffects: { publicEmployees: -7 }, locks: schoolModels, scheduledEvents: [delayedEvent("school-closures", "Des écoles deviennent non viables", "Plusieurs établissements perdent assez d'élèves pour menacer leur maintien dans des territoires fragiles.", 3, "institutionalTrust", -5)] },
      { id: "keep", label: "Conserver le financement des établissements", summary: "Les moyens restent attribués par réseau, territoire et caractéristiques des élèves.", budgetDelta: 0, beneficiaries: ["maillage scolaire", "établissements fragiles"], contributors: ["liberté de financement des familles"], indicatorEffects: { publicServices: 2 } },
    ],
  }),
  standalonePolicy({
    ...
    sourceKeys: ["depp-ecole-2025", "education-chiffres-2025"], evidenceLabel: "Effectifs et financement des établissements publics et privés sous contrat.", conflicts: schoolModels,
    options: [
      { id: "adopt", label: "Supprimer le financement", summary: "Les établissements privés financent seuls leur fonctionnement et le public doit accueillir les élèves transférés.", budgetDelta: 3_000, beneficiaries: ["finances publiques selon le transfert"], contributors: ["familles du privé", "établissements privés", "écoles publiques d'accueil"], uncertainty: "forte", indicatorEffects: { publicServices: -5, opinion: -4 }, groupEffects: { publicEmployees: -2 }, locks: schoolModels },
      { id: "keep", label: "Maintenir les contrats", summary: "L'État continue de payer les enseignants en échange des obligations du contrat.", budgetDelta: 0, beneficiaries: ["familles du privé", "continuité scolaire"], contributors: ["finances publiques"], indicatorEffects: { publicServices: 1 } },
    ],
  }),
  p({
  ...
  standalonePolicy({
    ...
    sourceKeys: ["depp-ecole-2025", "education-chiffres-2025"], evidenceLabel: "Affectation des enseignants, résultats et inégalités territoriales.", conflicts: schoolModels,
    options: [
      { id: "adopt", label: "Donner l'autonomie complète", summary: "Chaque établissement compose son équipe et ses primes dans son budget.", budgetDelta: 500, beneficiaries: ["établissements attractifs", "directions locales"], contributors: ["statut national", "établissements difficiles"], uncertainty: "forte", indicatorEffects: { reformCapacity: 7, publicServices: -2, opinion: -2 }, groupEffects: { publicEmployees: -8, unions: -9 }, locks: schoolModels, scheduledEvents: [delayedEvent("teacher-market", "Les écarts de recrutement explosent", "Les établissements difficiles doivent payer davantage sans toujours disposer de la même enveloppe.", 3, "publicServices", -6)] },
      { id: "keep", label: "Conserver l'affectation nationale", summary: "Les carrières et rémunérations restent nationales, avec des marges locales limitées.", budgetDelta: 0, beneficiaries: ["égalité statutaire", "enseignants"], contributors: ["autonomie locale"], indicatorEffects: { publicServices: 2 }, groupEffects: { publicEmployees: 3 } },
    ],
  }),
].map(policyDecision);
