...
type ConsequenceExtra = Partial<Pick<PolicyConsequence,
  "locks" | "unlocks" | "scheduledEvents" | "uncertainty"
>>;
...
const SOVEREIGNTY_AND_ENERGY: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "referendum-sur-la-sortie-de-l-ue": {
    adopt: consequence("Adopter la base du scrutin et ouvrir la campagne sans simuler à l'avance le résultat du vote.", immediate, ["Base constitutionnelle du référendum", "Organisation du scrutin", "La procédure de retrait ne commence qu'après un éventuel vote favorable"], { opinion: 4, financialCredibility: -10, institutionalTrust: -3 }, { businesses: -8, europeanPartners: -12 }, { uncertainty: "forte", scheduledEvents: [event("eu-referendum-market", "Les investissements attendent le vote", "Plusieurs décisions industrielles sont suspendues jusqu'au résultat et à ses suites.", 2, "indicator", "investment", -8)] }),
...
const EDUCATION_AND_STATE: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "ceder-des-participations-non-strategiques-de-l": {
    adopt: consequence("Vendre un portefeuille défini, affecter 2 000 millions d'euros au désendettement et renoncer aux dividendes futurs.", immediate, ["Autorisation législative si nécessaire", "Contraintes des services publics ou monopoles", "Valorisation, gouvernance et information des marchés"], { financialCredibility: 2, institutionalTrust: -1 }, { creditors: 2 }, { uncertainty: "forte" }),
