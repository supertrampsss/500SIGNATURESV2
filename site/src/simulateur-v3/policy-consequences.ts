...
type ConsequenceExtra = Partial<Pick<PolicyConsequence,
  "budgetDuration" | "budgetTiming" | "locks" | "unlocks" | "scheduledEvents" | "uncertainty"
>>;
...
function consequence(
  ...
  return {
    ...
    budgetTiming: extra.budgetTiming ?? immediate,
    indicatorEffects,
    groupEffects,
    locks: extra.locks ?? [],
...
const TAX_AND_WORK: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "retablir-un-impot-sur-la-fortune-financiere": {
    adopt: consequence("Taxer le patrimoine financier net au-dessus d'un seuil avec des règles de dette, valorisation, liquidité et actifs professionnels. Les 4 500 millions d'euros et l'effet d'investissement sont les hypothèses centrales du jeu, pas une prévision.", year(2), ["Loi de finances définissant seuil, assiette nette, dettes déductibles, actifs professionnels, exonérations, valorisation et plafonnement", "Respecter l'égalité devant les charges publiques et prévenir une charge confiscatoire, notamment pour les actifs illiquides", "Assurer une valorisation contradictoire des titres non cotés et permettre un paiement différé si la liquidité est insuffisante", "Respecter les libertés de circulation, la non-discrimination, les conventions fiscales et la double imposition", "Si une exit tax accompagne la réforme, la limiter à l'anti-évitement proportionné avec sursis, garanties et dégrèvement compatibles avec l'Union"], { investment: -2 }, { businesses: -2 }),
  ...
  "flat-tax-a-20-avec-abattement-protegeant": {
    adopt: consequence("Déduire un abattement encore à publier par foyer ou part puis appliquer 20 % au revenu taxable restant. Les 12 000 millions d'euros de coût sont une hypothèse du jeu tant que montant et unité fiscale ne sont pas définis.", year(1), ["Loi de finances", "Publier le montant de l'abattement", "Définir l'unité foyer ou part", "Respecter l'égalité et les charges de famille"], { investment: 2, institutionalTrust: -3 }, { businesses: 2 }, { locks: ["flat-tax-a-20-des-le-premier", ...FLAT_TAX_CONFLICTS], uncertainty: "forte" }),
  ...
  "impot-plancher-de-2-sur-les-patrimoines": {
    adopt: consequence("Calculer un complément pour porter à 2 % l'imposition annuelle des patrimoines couverts. Les 15 000 millions d'euros sont une hypothèse très contestée du jeu, sensible à l'assiette, à la valorisation, à la liquidité et aux départs.", year(2), ["Loi de finances", "Facultés contributives et risque confiscatoire", "Revenus latents et liquidité", "Valorisation et liberté de circulation", "Définir les impôts créditables et leur période d'imputation pour éviter tout double compte avec l'IFI ou un autre impôt sur la fortune"], { institutionalTrust: 3, investment: -4 }, { businesses: -4 }, { uncertainty: "forte" }),
  ...
  "durcir-l-assurance-chomage-degressivite-duree": {
    adopt: consequence("Définir la cohorte, la réduction de durée, le seuil de dégressivité, son rythme, son plancher et la condition conjoncturelle.", year(2), ["Négociation des partenaires sociaux et agrément", "À défaut d'accord, décret de l'État", "Droits transitoires", "Plancher de revenu"], { employment: 1 }, { privateEmployees: -3, unions: -2, businesses: 1 }, { budgetTiming: year(2), uncertainty: "forte" }),
  ...
  "ouvrir-un-etage-de-capitalisation-collective": {
    adopt: consequence("Affecter une part encore à publier des cotisations à un véhicule collectif tout en compensant intégralement la transition des pensions courantes. Le coût de 500 millions d'euros et l'effet d'investissement sont des hypothèses du jeu.", year(3), ["Loi définissant caractère obligatoire, taux affecté, prestations, gouvernance et garantie des droits", "Appliquer la directive (UE) 2016/2341 IORP II si le véhicule est une institution de retraite professionnelle", "Respecter la directive 2014/50/UE sur l'acquisition, la préservation et la mobilité des droits", "Organiser portabilité, politique d'investissement, conservation des actifs, frais et financement explicite de la transition"], { investment: 3 }, { privateEmployees: -3, businesses: 1 }, { uncertainty: "forte" }),
  ...
  "retablir-la-semaine-de-39-heures": {
    adopt: consequence("Fixer le seuil légal à 39 heures avec salaire mensuel de base inchangé lorsque contrats ou accords l'acceptent. Les 2 000 millions d'euros et +0,12 point de croissance nominale sont des hypothèses du jeu; une compensation salariale intégrale en annulerait une large part.", year(2), ["Loi modifiant la durée légale du travail et les seuils de déclenchement des heures supplémentaires", "Respecter la directive 2003/88/CE et le Code du travail : 48 heures au plus sur une semaine, 44 heures en moyenne sur douze semaines, repos quotidien et hebdomadaire", "Le relèvement de la durée légale ne permet ni de réduire unilatéralement le salaire contractuel ni de modifier sans accord les conventions et accords collectifs plus favorables", "Définir le traitement transitoire des contrats, forfaits, temps partiels et contingents d'heures supplémentaires"], { growth: 0.12, employment: -2 }, { businesses: 5, unions: -8, privateEmployees: -5 }, { budgetTiming: year(2), uncertainty: "forte", scheduledEvents: [event("hours-wage-bargain", "Les négociations salariales mettent le scénario à l'épreuve", "Dans le stress retenu par le jeu, les conflits sur la compensation des quatre heures retardent l'organisation du travail et certaines embauches.", 2, "indicator", "employment", -2)] }),
  ...
  "allocation-sociale-unique": {
    adopt: consequence("Remplacer RSA, prime d'activité et APL par un barème de ménage publié avec calcul et versement automatiques. Le gain de 1 000 millions d'euros suppose dans le jeu que baisses de droits et gestion dépassent non-recours résorbé et transition; le signe distributif reste provisoire sans microsimulation.", year(3), ["Lois modifiant les régimes du RSA, de la prime d'activité et des aides personnelles au logement, avec barème, unité de ressources, période de référence et transition explicitement définis", "Respecter la libre administration et l'autonomie financière des départements ; compenser toute charge nouvelle ou tout transfert relatif au RSA dans les conditions de l'article 72-2 de la Constitution", "Respecter le règlement (CE) n° 883/2004, l'égalité de traitement et les règles de coordination européenne applicables aux prestations fusionnées", "Donner au croisement de données une base légale conforme au RGPD : finalités déterminées, minimisation, durée de conservation, information et sécurité", "Pour toute décision entièrement automatisée produisant un effet juridique, garantir explication, intervention humaine, rectification et recours ; définir aussi la récupération des indus et le maintien temporaire des droits"], { publicServices: 2, institutionalTrust: 2 }, { lowIncomeHouseholds: -1 }, { budgetTiming: year(3), locks: ["verser-le-rsa-automatiquement-fin-du-non", "porter-le-rsa-au-seuil-de"], uncertainty: "forte", scheduledEvents: [event("single-benefit-losers", "Le premier versement révèle des perdants", "Certaines configurations familiales reçoivent moins avec le barème provisoire de la prestation unique.", 3, "group", "lowIncomeHouseholds", -3)] }),
...
const HEALTH_AND_SECURITY: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "construire-15-000-places-de-prison-supplementaires": {
    adopt: consequence("Acquérir les sites, passer les marchés, construire, recruter les surveillants et ouvrir progressivement les places pour 500 millions d'euros par an pendant dix ans dans le scénario.", year(4), ["Commande publique", "Urbanisme et environnement", "Normes constitutionnelles et CEDH de détention", "Crédits de fonctionnement et de personnel"], { publicServices: 3, reformCapacity: -3 }, { publicEmployees: 3, localAuthorities: -2 }),
  ...
  "reserver-les-prestations-non-contributives-aux-nationaux": {
    adopt: consequence("Appliquer une condition de cinq ans de résidence régulière uniquement aux prestations pour lesquelles le droit supérieur le permet.", immediate, ["Égalité constitutionnelle des étrangers résidant durablement", "Libre circulation et coordination sociale européenne", "Égalité des réfugiés", "Dignité et non-discrimination"], { institutionalTrust: -6, reformCapacity: -3, opinion: 2 }, { lowIncomeHouseholds: -8, europeanPartners: -5, localAuthorities: -4 }, { uncertainty: "forte", scheduledEvents: [event("benefits-constitutional-review", "Les recours retardent l'application", "Les recours imposent de reprendre la motivation et le traitement de certains dossiers. Le périmètre chiffré du scénario reste inchangé.", 2, "indicator", "reformCapacity", -4)] }),
...
const SOVEREIGNTY_AND_ENERGY: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "doubler-les-moyens-du-renseignement-interieur": {
    adopt: consequence("Recruter des personnels habilités, acheter les systèmes nécessaires et renforcer simultanément les contrôles.", after(2), ["Crédits de la loi de finances", "Code de la sécurité intérieure et finalités légales des techniques de renseignement", "Autorisation, nécessité et proportionnalité des techniques", "Contrôle de la CNCTR et recours juridictionnel", "Protection des données, habilitations et secret de la défense nationale"], { publicServices: 4, institutionalTrust: -2 }, { publicEmployees: 2 }),
  ...
  "achats-militaires-europeens-prioritaires": {
    adopt: consequence("Inclure des exigences européennes objectivement liées au marché et accepter un surcoût ou délai lorsque l'autonomie stratégique le justifie.", after(2), ["Appliquer la directive 2009/81/CE et, entre opérateurs de l'Union, l'égalité de traitement, la non-discrimination, la proportionnalité et la transparence", "Fonder la sélection sur des exigences du marché telles que sécurité d'approvisionnement, informations classifiées ou interopérabilité", "N'utiliser l'article 346 paragraphe 1 b TFUE qu'au cas par cas, si nécessaire et proportionné à un intérêt essentiel de sécurité, avec justification documentée"], { investment: 5, publicServices: -1, financialCredibility: -1 }, { businesses: 4, europeanPartners: 4 }),
  ...
  "budget-europeen-de-defense": {
    adopt: consequence("Créer une ressource ou une habilitation spécifique de dette commune et attribuer les fonds à des programmes décidés collectivement, avec une économie nette française hypothétique de 2 000 millions d'euros.", after(3), ["Décision sur les ressources propres à l'unanimité du Conseil après consultation du Parlement selon l'article 311 TFUE", "Approbation par tous les États membres conformément à leurs règles constitutionnelles avant entrée en vigueur", "Unanimité du Conseil et approbation du Parlement pour modifier le cadre financier pluriannuel selon l'article 312 TFUE", "Base juridique sectorielle, inscription budgétaire et habilitation spécifique à emprunter; l'article 311 ne suffit pas seul"], { financialCredibility: 3, reformCapacity: 2, publicServices: 2 }, { europeanPartners: 7, creditors: 1 }, { uncertainty: "forte", scheduledEvents: [event("eu-defense-veto", "Un partenaire retarde un programme commun", "Le partage des priorités retarde une capacité pourtant financée collectivement.", 3, "indicator", "reformCapacity", -3)] }),
  ...
  "sortir-de-l-euro": {
    adopt: consequence("Obtenir une base conventionnelle de retrait, voter la conversion, adapter banques et paiements puis laisser flotter la nouvelle monnaie.", after(1), ["Les traités ne prévoient aucune procédure autonome de sortie du seul euro pour un État sans dérogation", "Obtenir un accord de droit primaire, par révision des traités ou retrait de l'Union selon l'option politique", "Traiter constitutionnalité, statut de la banque centrale et relations avec l'Eurosystème", "Garantir paiements, dépôts, conversion des contrats et dettes, notamment sous droit étranger", "Encadrer les mouvements de capitaux dans le respect du droit de l'Union et protéger les déposants"], { interestCost: { delta: 12_000, duration: "annual", explanation: "Le scénario retient une hausse annuelle hypothétique de 12 000 millions d'euros de la charge d'intérêt; ce stress n'est pas une prévision officielle." }, investment: -15, financialCredibility: -20, institutionalTrust: -8 }, { creditors: -20, europeanPartners: -15, businesses: -12, lowIncomeHouseholds: -8 }, { budgetDuration: "once", uncertainty: "forte", scheduledEvents: [event("currency-conversion", "La conversion perturbe les paiements", "Dans le stress du jeu, les banques limitent temporairement certains mouvements et les importations renchérissent.", 1, "indicator", "institutionalTrust", -10)] }),
  ...
  "creer-une-armee-europeenne": {
    adopt: consequence("Conclure un accord de commandement commun et désigner les unités intégrées, avec une économie nette française hypothétique de 3 000 millions d'euros.", after(4), ["Décision du Conseil européen à l'unanimité pour une défense commune selon l'article 42 paragraphe 2 TUE", "Adoption par chaque État membre conformément à ses règles constitutionnelles", "Respect des obligations découlant de l'OTAN et unanimité des décisions PSDC selon l'article 42 paragraphe 4", "Définir contrôle démocratique, règles d'engagement et chaîne nationale de décision nucléaire"], { reformCapacity: 5, publicServices: 4, financialCredibility: 2 }, { europeanPartners: 10, publicEmployees: 2 }, { uncertainty: "forte" }),
  ...
  "nationaliser-les-entreprises-strategiques": {
    adopt: consequence("Voter le périmètre, valoriser les titres, indemniser les actionnaires et transférer le contrôle à l'État.", after(3), ["Loi définissant précisément le périmètre et constatant la nécessité publique", "Indemnité juste et préalable et recours effectif selon l'article 17 de la Déclaration des droits de l'homme et du citoyen", "Valorisation contradictoire, prime de contrôle, passifs repris et droits des actionnaires", "Droit européen de la concurrence, aides d'État et libre circulation des capitaux"], { investment: -5, financialCredibility: -8, reformCapacity: -4 }, { businesses: -10, creditors: -5, publicEmployees: 3 }, { budgetDuration: "once", uncertainty: "forte" }),
  ...
  "moratoire-sur-les-renouvelables": {
    adopt: consequence("Réviser régulièrement la PPE et arrêter prospectivement les nouveaux appels d'offres, sans annuler indistinctement permis, droits ou contrats acquis.", immediate, ["Réviser la programmation pluriannuelle de l'énergie selon le Code de l'énergie", "Respecter les objectifs européens renouvelables et les procédures accélérées de permis prévues par RED III", "Instruire les autorisations selon les procédures et délais applicables", "Honorer ou retirer sur une base légale les autorisations définitives, lauréats et contrats de soutien, avec procédure et indemnisation éventuelle"], { investment: -8, publicServices: -5, opinion: 3 }, { businesses: -5, localAuthorities: -3 }, { locks: ["sortie-du-nucleaire-en-2040"], uncertainty: "forte" }),
  ...
  "interdire-les-voitures-thermiques-en-2030": {
    adopt: consequence("Notifier et voter une restriction nationale sur les ventes neuves puis financer bornes, adaptation industrielle et compensations ciblées.", after(2), ["Loi de finances", "Le règlement (UE) 2023/851 fixe pour 2035 un objectif de réduction de 100 % des émissions moyennes des voitures neuves, pas une interdiction nationale simple", "Respecter les règles européennes de réception des véhicules, la libre circulation, la notification et la proportionnalité"], { investment: 6, employment: -3, opinion: -7 }, { businesses: -4, lowIncomeHouseholds: -5, middleClasses: -4 }, { uncertainty: "forte" }),
...
const EDUCATION_AND_STATE: Record<string, Record<string, PolicyConsequence>> = {
  ...
  "etendre-le-dedoublement-des-classes-au-cm1": {
    adopt: consequence("Affecter des postes et salles supplémentaires aux CM1 et CM2 de l'éducation prioritaire par vagues territoriales.", after(3), ["Ouvrir emplois et crédits", "Adapter carte scolaire et affectations", "Disposer de locaux communaux conformes"], { publicServices: 5 }, { publicEmployees: 2, localAuthorities: -2 }, { budgetTiming: after(3) }),
  ...
  "supprimer-le-financement-public-du-prive": {
    adopt: consequence("Résilier progressivement les contrats et accueillir dans le public les élèves transférés; l'économie brute dépend de la capacité d'accueil.", after(2), ["Modifier les dispositions L442 du Code de l'éducation", "Traiter contrats et droits des personnels", "Garantir liberté d'enseignement et continuité", "Financer locaux et accueil publics"], { reformCapacity: -5, institutionalTrust: -3, publicServices: -4 }, { localAuthorities: -5, publicEmployees: -2 }, { budgetTiming: after(2), locks: ["cheque-education-par-eleve"], uncertainty: "forte", scheduledEvents: [event("private-school-transfer-capacity", "Les transferts saturent une partie du public", "Les établissements publics d'accueil manquent temporairement de salles et de personnels dans plusieurs territoires.", 2, "indicator", "publicServices", -3)] }),
  ...
  "fermer-un-tiers-des-agences-et-operateurs": {
    adopt: consequence("Identifier les structures, supprimer ou transférer chaque mission puis reprendre contrats, dettes et agents.", after(2), ["Acte adapté au texte de création", "Transférer actifs, passifs, contrats et contentieux", "Droits des agents et continuité"], { reformCapacity: 3, publicServices: -5 }, { publicEmployees: -6 }, { budgetTiming: after(2), uncertainty: "forte", scheduledEvents: [event("agency-mission-transfer", "Les missions changent d'adresse sans disparaître", "Plusieurs fonctions sont reprises par les ministères avec des coûts de transition et des délais pour les usagers.", 2, "indicator", "institutionalTrust", -3)] }),
  ...
  "reduire-de-5-les-dotations-aux-collectivites": {
    adopt: consequence("Réduire les concours en loi de finances; les exécutifs locaux arbitrent ensuite entre investissement, service et recettes.", after(3), ["Voter la baisse en loi de finances", "Libre administration et autonomie financière", "Compensation des compétences transférées"], { investment: -2, publicServices: -3 }, { localAuthorities: -9, businesses: -3 }, { budgetTiming: after(3), scheduledEvents: [event("local-investment-cut", "L'investissement local devient la variable d'ajustement", "Une partie des collectivités concentre la baisse sur les chantiers et commandes locales plutôt que sur les services courants.", 3, "indicator", "investment", -3)] }),
  ...
  "regle-d-or-constitutionnelle": {
    adopt: consequence("Adopter la révision puis appliquer, au premier budget contrôlé par la règle, une correction de scénario de 8 000 millions d'euros; ce montant n'est pas une économie constitutionnelle automatique.", after(3), ["Révision constitutionnelle", "Définir solde, méthode et exceptions", "Articuler les règles européennes", "Désigner le contrôle et les conséquences"], { financialCredibility: 8, reformCapacity: -6 }, { creditors: 7, parliamentaryMajority: -6 }, { budgetTiming: after(3), uncertainty: "forte", scheduledEvents: [event("golden-rule-recession", "Un ralentissement met la règle à l'épreuve", "Dans ce stress de scénario, la baisse des recettes force une correction procyclique faute de clause d'exception suffisante.", 3, "indicator", "growth", -0.35)] }),
  ...
  "supprimer-les-departements": {
    adopt: consequence("Transférer bloc par bloc prestations sociales, collèges, routes, agents, dette et systèmes d'information.", after(3), ["Réviser ou appliquer l'article 72", "Lois de transfert des compétences, ressources et personnels", "Compensation et continuité des droits sociaux", "Traiter les statuts ultramarins"], { reformCapacity: 5, publicServices: -6 }, { localAuthorities: -9, publicEmployees: -5 }, { budgetTiming: after(3), uncertainty: "forte", scheduledEvents: [event("department-social-transfer", "Le transfert social se grippe", "Les systèmes d'aide sociale et de paiement ne communiquent pas encore, ce qui allonge les délais pour les bénéficiaires.", 3, "indicator", "institutionalTrust", -6)] }),
