...
type Definition = readonly [id: string, sources: readonly string[]];

// An option is either `-` (the one neutral maintenance profile) or one exact
// V10 option. Combined cards deliberately select one source profile at a time.
const definitions: readonly Definition[] = [
  ["v11-01-prelevement-personnel", ["unifier-ir-csg-bareme-continu:adopt", "-"]],
  ["v11-02-tva", ["-", "porter-le-taux-normal-de-tva-a:adopt", "relever-tva-restauration-commerciale:adopt"]],
  ...
  ["v11-07-aides-emploi", ["-", "cibler-aides-apprentissage:adopt", "recentrer-allegements-exonerations-sociales:adopt"]],
  ["v11-08-aides-entreprises", ["-", "supprimer-subventions-directes-entreprises:adopt", "recentrer-cir-niches-fiscales-entreprises:adopt"]],
  ...
  ["v11-15-financement-soins", ["-", "doubler-les-franchises-medicales:adopt", "fiscalite-nutritionnelle-au-niveau-recommande:adopt"]],
  ...
  ["v11-19-prestations", ["-", "unifier-instruction-prestations-solidarite:adopt"]],
  ...
  ["v11-23-effectifs-publics", ["-", "ne-pas-remplacer-un-depart-administratif-sur:adopt", "reduire-cout-absences-fonctions-publiques:adopt"]],
  ["v11-24-frais-structure", ["-", "rationaliser-operateurs-ingenierie-territoriale:adopt", "mutualiser-achats-publics:adopt"]],
  ...
  ["v11-26-collectivites", ["-", "clarifier-competences-doublons-territoriaux:adopt", "supprimer-les-departements:adopt"]],
  ...
  ["v11-47-energies-fossiles", ["-", "retablir-une-trajectoire-carbone-recettes-redistribuees:adopt", "retablir-une-trajectoire-carbone-recettes-redistribuees:adopt"]],
...
const sourceDecision = (sources: readonly string[]) => sourceById.get(sources.find((source) => source !== "-")!.split(":")[0])!;
...
function optionFor(reference: string, id: string, copy: (typeof V11_COPY)[number]["options"][number]): DecisionOption {
