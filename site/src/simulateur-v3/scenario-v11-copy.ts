...
const outcomeRows = [
  ...
  ["Les taux actuels restent en place.", "Les achats au taux normal peuvent coûter plus cher et l'État reçoit plus de taxe.", "Restaurants, prix ou marges absorbent la hausse de taxe.", "Le taux normal et celui de la restauration augmentent, tandis que les factures électroniques renforcent le contrôle de la taxe."],
  ...
  ["Les aides et exonérations actuelles continuent.", "Les aides sont réservées aux contrats et formations retenus.", "Les employeurs visés cotisent davantage au-dessus du seuil.", "Les aides à l'apprentissage sont ciblées et les exonérations au-dessus du seuil diminuent."],
  ["Subventions et crédit d'impôt recherche restent inchangés.", "Les entreprises perdent les subventions visées à la fin des contrats.", "Le taux, les plafonds ou la liste du crédit d'impôt recherche changent.", "Les subventions directes visées diminuent et le crédit d'impôt recherche est recentré."],
  ...
  ["Franchises et taxes concernées ne changent pas.", "Les patients paient davantage sur médicaments et actes concernés.", "Les consommateurs de sucre et d'alcool paient davantage.", "Les franchises médicales et les taxes sur le sucre et l'alcool augmentent ensemble."],
  ...
  ["Les démarches restent séparées.", "Une même demande déclenche instruction et versement.", "Une même demande déclenche instruction et versement, avec davantage de sommes fraudées effectivement récupérées."],
  ...
  ["Les départs et rémunérations suivent la trajectoire actuelle.", "Une partie des départs n'est pas remplacée.", "La prévention et le contrôle réduisent les absences évitables.", "Une partie des départs n'est pas remplacée et les absences évitables diminuent."],
  ["L'organisation actuelle est conservée.", "Des opérateurs sont regroupés.", "Les achats publics sont mutualisés.", "Des opérateurs sont regroupés, les achats mutualisés et les surfaces louées réduites."],
  ["Des participations publiques sont vendues.", "Le portefeuille public est conservé.", "L'État achète les entreprises désignées."],
  ["L'organisation territoriale reste inchangée.", "Compétences et financement sont transférés ensemble.", "Les compétences départementales sont transférées avant la suppression de cet échelon.", "Les doublons de compétences sont supprimés et les départements disparaissent après transfert de leurs missions."],
  ...
  ["Le cadre national est conservé.", "Les établissements reçoivent plus d'autonomie.", "Le financement public du privé diminue.", "Les établissements gagnent en autonomie et le financement public du privé diminue."],
  ...
  ["Les moyens actuels sont conservés.", "L'instruction est renforcée pour réduire les délais.", "Les décisions arrivent plus vite et l'allocation versée pendant l'attente est supprimée."],
  ...
  ["La taxe ne change pas.", "La hausse de taxe ne donne lieu à aucun remboursement.", "Une partie de la recette est versée aux ménages retenus.", "La taxe sur les énergies fossiles augmente et les billets d'avion sont davantage taxés."],
  ...
  ["Les décisions restent nationales.", "Certains programmes sont achetés et financés en commun.", "Des unités désignées passent sous commandement commun.", "Des unités passent sous commandement commun et une partie du budget d'aide au développement finance cet effort."],
