...
export default defineConfig({
 testDir:'./tests',testMatch:['mandats-mobile.test.mjs','editorial-tabs.test.mjs','france-living.test.mjs','national-agenda.test.mjs','shared-theme.test.mjs'],timeout:60000,expect:{timeout:10000},fullyParallel:true,workers:2,retries:process.env.CI?1:0,
