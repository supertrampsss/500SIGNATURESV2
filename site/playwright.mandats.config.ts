...
export default defineConfig({
 testDir:'./tests',testMatch:'mandats-mobile.test.mjs',timeout:60000,expect:{timeout:10000},fullyParallel:true,workers:2,retries:process.env.CI?1:0,
 ...
 projects:[
  {name:'android-chromium',use:{...devices['Pixel 5'],viewport:{width:390,height:844}}},
